...
from apps.about.models import About, AboutTranslation
...
class Command(BaseCommand):
    help = "Create or update the bilingual About me content."

    @transaction.atomic
    def handle(self, *args, **options):
        about, _ = About.objects.get_or_create(singleton=True)
        about.is_visible = True
        about.save()

        for language_code, content in ABOUT_TRANSLATIONS.items():
        ...
        self.stdout.write(self.style.SUCCESS("Bilingual About me content is ready."))
