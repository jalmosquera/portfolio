      ...
      <div className="max-w-6xl mx-auto px-6 text-center space-y-6">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-2.5 bg-[#1a1a1a] border border-[#252525] rounded-lg text-[#d1d5db] text-sm font-medium hover:border-[#444] transition-colors"
          >
