      ...
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <a
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-card border border-border rounded-lg text-text text-sm hover:border-accent hover:text-accent transition-all"
          >
